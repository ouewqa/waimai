...
class AlipayProxy extends CComponent
{
    ...
    public function changeAccount($key = null, $partner = null, $seller_email = null)
    {
    ...
    public function buildForm($request)
    {
        ...
        $params = array(
                ...
                'return_url' => Yii::app()->request->hostInfo . $this->return_url,
                'notify_url' => Yii::app()->request->hostInfo . $this->notify_url,
