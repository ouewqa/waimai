...
class SiteProductOrderController extends ConsoleController
{
	...
	{
		$dataProvider=new CActiveDataProvider('SiteProductOrder');
	...
	{
		$model=new SiteProductOrder('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['SiteProductOrder'])) {
			$model->attributes=$_GET['SiteProductOrder'];
		}
