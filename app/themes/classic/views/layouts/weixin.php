...
<head>
    ...
    <?php if ($this->shop && $this->shop->style): ?>
        <link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/<?php echo $this->shop->style; ?>.css"
              rel="stylesheet">
    <?php else: ?>
        <link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/weixin.css" rel="stylesheet">
    <?php endif; ?>
    ...
    if (ISWEIXINCLIENT || YII_DEBUG) {
        Yii::app()->getclientScript()->registerScriptFile("/js/WeixinApi.js", CClientScript::POS_END);
    }
    ?>
</head>
<body>
