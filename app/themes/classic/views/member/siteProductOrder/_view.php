...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('order_sn')); ?>:</b>
	<?php echo CHtml::encode($data->order_sn); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('site_product_id')); ?>:</b>
	<?php echo CHtml::encode($data->site_product_id); ?>
	<br />
