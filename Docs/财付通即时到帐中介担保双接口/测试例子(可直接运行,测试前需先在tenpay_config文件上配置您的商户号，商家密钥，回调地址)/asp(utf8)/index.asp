...
<form action="tenpay.asp" method="get" name="directFrm" onSubmit="return payFrm();">
            <tr>
              <td align="left"><table width="760" height="30" border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#FFCC00">
                  <tr>
                    <td align="center" valign="top" bgcolor="#FFFFEE"><table width="760" height="351" border="0" cellpadding="6" cellspacing="0" class="px14" style="display:">
                      <tr>
                        <td height="26" align="right" valign="top">&nbsp;</td>
                        <td valign="top"> 　 </td>
                        <td width="262" rowspan="8" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="5">
                            <tr>
                      ...
                      <tr>
                        <td width="96" height="26" align="right" valign="top">收款方： </td>
                        <td width="353" valign="top" align="left"><%=spname %></td>
                      </tr>
                      <tr>
...
%>
                      ...
                      <tr>
                        ...
                        <td valign="top" align="left"><span style="color:#000000;font-size:12px;">
                          <input name="product_name" type="text" size="18" maxlength="50"  />
                        </span></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top">付款金额： </td>
                        <td valign="top" align="left"><input type="text" name="order_price" maxlength="50" size="18" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"  />
                          元（格式：500.01）</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td valign="top"><textarea name="remarkexplain" cols="40" rows="5" id="remark2" ></textarea>
                            <br />
